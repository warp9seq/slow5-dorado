    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64*|^arm*")
            ...
            elseif (TRY_USING_STATIC_TORCH_LIB)
                ...
                if(DORADO_USING_OLD_CPP_ABI)
                    set(TORCH_URL https://download.pytorch.org/libtorch/cu126/libtorch-shared-with-deps-${TORCH_VERSION}%2Bcu126.zip)
                    set(TORCH_PATCH_SUFFIX -pre-cxx11)
                    set(TORCH_HASH "2e646fd8a439a2a4440ed45c58e8f8709475a4414f82c126a87494a5c50b92d8")
                else()
